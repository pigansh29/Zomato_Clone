              ...
              <div className="reel-actions">
                ...
                <div className="reel-action-group">
                  <button
                    ...
                    aria-label="Bookmark"
                  >
                    <svg width="22" height="22" viewBox="0 0 24 24" fill={item.isSaved ? "white" : "none"} stroke={item.isSaved ? "white" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
